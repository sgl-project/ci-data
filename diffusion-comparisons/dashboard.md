...
*Generated: Jul 14 | Commit: `cfe4eef`*

> [!WARNING]
> **Performance Regression Detected**
>
> - **qwen_image_2512_t2i_1024** (sglang): 8.77s -> 10.73s (+22.3%)
> - **ltx2.3_twostage_ti2v_2gpus** (sglang): 13.05s -> 17.08s (+30.8%)
...
| FLUX.1-dev | ✅ | **4.87** |
| FLUX.2-dev | ✅ | **14.47** |
| Qwen-Image-2512 | ⚠️ | **10.73** |
| Qwen-Image-Edit-2511 | ✅ | **15.40** |
| Z-Image-Turbo | ✅ | **0.84** |
...
| Wan2.2-I2V-A14B-Diffusers | ✅ | **204.63** |
...
| Jun 23 | `a17753e` | 4.68 | 14.34 | 12.80 | 23.72 | 0.64 | 211.07 | 65.22 | 14.05 | N/A | N/A | 205.68 | -- |

> [!CAUTION]
> **Action Required — Performance Alert**
>
> The following cases need attention:
> - qwen_image_2512_t2i_1024: SGLang regression +22.2% vs 3-run avg (10.73s vs 8.78s)
> - ltx2.3_twostage_ti2v_2gpus: SGLang regression +30.8% vs 3-run avg (17.08s vs 13.06s)
