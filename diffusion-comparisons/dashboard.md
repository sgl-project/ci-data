...
*Generated: Jul 16 | Commit: `b0b2dfb`*

> [!WARNING]
> **Performance Regression Detected**
>
> - **qwen_image_2512_t2i_1024** (sglang): 8.82s -> 10.80s (+22.4%)
> - **ltx2.3_twostage_ti2v_2gpus** (sglang): 13.06s -> 16.06s (+23.0%)
...
| FLUX.1-dev | ✅ | **4.87** |
| FLUX.2-dev | ✅ | **14.41** |
| Qwen-Image-2512 | ⚠️ | **10.80** |
| Qwen-Image-Edit-2511 | ✅ | **15.41** |
| Z-Image-Turbo | ✅ | **0.83** |
| Wan2.2-T2V-A14B-Diffusers | ✅ | **210.62** |
| Wan2.2-TI2V-5B-Diffusers | ✅ | **65.24** |
| LTX-2.3 | ⚠️ | **16.06** |
| ideogram-4-fp8 | ✅ | **5.35** |
| Cosmos3-Super | ✅ | **115.35** |
...
| Jun 24 | `5e6d7c1` | 4.68 | 14.36 | 12.82 | 23.75 | 0.64 | 209.73 | 65.22 | 14.06 | N/A | N/A | 205.65 | -- |

> [!CAUTION]
> **Action Required — Performance Alert**
>
> The following cases need attention:
> - qwen_image_2512_t2i_1024: SGLang regression +14.4% vs 3-run avg (10.80s vs 9.44s)
> - ltx2.3_twostage_ti2v_2gpus: SGLang regression +11.6% vs 3-run avg (16.06s vs 14.40s)
